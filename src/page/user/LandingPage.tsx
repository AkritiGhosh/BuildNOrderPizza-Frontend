...
const LandingPage = () => {
  return (
    <PageLayout
      className={`bg-cover bg-right bg-fixed overflow-auto bg-[url("src/assets/light_bg.jpg")] dark:bg-[url("src/assets/dark_bg.jpg")]`}
    >
      <div className="w-full h-full flex items-center">
        <div className="md:w-3/5 lg:w-2/5  h-auto pl-4 md:pl-[5%] px-4 text-right text-black dark:text-white">
          ...
          <button className="w-auto h-12 mt-10 px-2 py-1 pr-3 rounded hover:bg-amber-400/20 dark:hover:bg-slate-300/20 group">
            <Link
